...
export default function Projects() {
  ...
  const projectsData = [
    ...
    {
      id: 'amani-kwetu',
      title: 'Fondation Amani Kwetu',
      badge: 'Site Vitrine & Humanitaire',
      category: 'fullstack',
      image: `${import.meta.env.BASE_URL}images/projects/amani-kwetu.png`,
      description: 'Site vitrine de promotion des activités de la Fondation Amani Kwetu, axé sur la prise en charge et le suivi des enfants et femmes abandonnés (Éducation, Entrepreneuriat, Santé, Environnement).',
      fullDescription: 'Site web vitrine développé pour promouvoir les actions humanitaires de la Fondation Amani Kwetu. La plateforme présente la prise en charge et le suivi des enfants et des femmes abandonnés à travers quatre piliers majeurs : Éducation, Entrepreneuriat, Santé et Environnement.',
      tech: ['HTML', 'CSS', 'JavaScript', 'PHP', 'Bootstrap 5', 'SEO'],
      features: [
        'Prise en charge et suivi des enfants et femmes abandonnés',
        'Mise en valeur des 4 axes : Éducation, Entrepreneuriat, Santé, Environnement',
        'Plateforme professionnelle de présentation et sensibilisation',
      ],
      github: null,
      demoUrl: 'https://amani-kwetu-fondation.vercel.app/',
    },
    {
      id: 'incidents',
      ...
      description: 'Application mobile (Flutter) permettant aux citoyens de signaler des incidents et dashboard web (React) pour l\'administration et les services concernés.',
      fullDescription: 'Projet majeur conçu pour le diplôme de Licence en Génie Logiciel. Il comprend une application mobile sous Flutter permettant aux citoyens de signaler des incidents urbains en temps réel et un dashboard web sous React dédié à l\'administration et au suivi de traitement par les services concernés.',
      tech: ['Flutter', 'Firebase', 'React', 'Bootstrap 5', 'Git / GitHub'],
      features: [
        'Application mobile (Flutter) pour le signalement d\'incidents par les citoyens',
        'Dashboard web (React) pour l\'administration et le suivi par les services concernés',
        'Authentification, gestion des rôles, catégorisation, suivi de statut et API REST',
      ],
    ...
    },
    {
      ...
      category: 'fullstack',
      image: `${import.meta.env.BASE_URL}images/projects/regideso.jpeg`,
    ...
    },
    {
      ...
      category: 'backend',
      image: `${import.meta.env.BASE_URL}images/projects/uscitech-vote.jpeg`,
